...
Test-Case 'optional caller assertion can exact-match observed native session' { $null=ConvertFrom-V02HerdrAgentListObservation (New-AgentListJson) 'v02-runtime-target' ('1'*32) }
Test-Case 'optional caller assertion mismatch fails closed' { $null=ConvertFrom-V02HerdrAgentListObservation (New-AgentListJson) 'v02-runtime-target' ('9'*32) } $true
