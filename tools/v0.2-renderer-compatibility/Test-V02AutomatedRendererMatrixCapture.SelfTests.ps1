...
& dotnet build (Join-Path $repo 'src\HerdrOps.App\HerdrOps.App.csproj') --configuration Release --no-restore --no-incremental --artifacts-path (Join-Path $repo 'artifacts')
